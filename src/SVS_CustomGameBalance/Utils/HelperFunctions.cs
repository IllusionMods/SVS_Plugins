...
namespace SVS_CustomGameBalance
{
    internal static class HelperFunctions
    {
        ...
        public static KeyValuePair<int, Actor> FindMainActorInstanceMemory(this MemoryParameter x) => x == null ? default : Manager.Game.Charas.AsManagedEnumerable().FirstOrDefault(y => x.Pointer == y.Value.charasGameParam.memory.Pointer);
